...
class ChatViewController: UIViewController, UITextFieldDelegate, UITableViewDelegate, UITableViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        //checks in the user to the event. whoever sent the request is the person
        //who is going to have their name updated on firebase
        ...
        let usersRef = currRef.childByAppendingPath("Attendees")
        let guest = userInfo.name
        
        let attendees = [guest: user]
        usersRef.setValue(attendees)
